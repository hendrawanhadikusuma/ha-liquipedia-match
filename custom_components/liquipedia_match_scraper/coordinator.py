...
from .const import CONF_GMT_OFFSET, CONF_SCORE_URL, CONF_TEAM_URL, DEFAULT_GMT_OFFSET, DEFAULT_SCAN_INTERVAL, DOMAIN
...
class LiquipediaMatchCoordinator(DataUpdateCoordinator[LiquipediaMatchData]):
    def __init__(self, hass: HomeAssistant, entry: ConfigEntry) -> None:
        ...
        self.scraper = LiquipediaMatchScraper(
            ...
            gmt_offset=entry.options.get(CONF_GMT_OFFSET, DEFAULT_GMT_OFFSET),
        )
